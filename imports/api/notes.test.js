...
if (Meteor.isServer) {
  ...
  it('should throw error if extra updates provided', function() {
    ...
    it('should return no notes for the user that has none', function () {
      const res = Meteor.server.publish_handlers.notes.apply({ userId: 'This got no notes.' });
      const notes = res.fetch();
